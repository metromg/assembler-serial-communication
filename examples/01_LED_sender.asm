...
main:	ldi	r16,lo8(RAMEND)
	...
	sbi	ioPORTD,2 ; Pull-Up Widerstand für Taster 1
	sbi ioPORTD,3 ; Pull-Up Widerstand für Taster 2

	ldi	r17,0 ; SRC auf 0 setzen
;------------------------------------------------------------------------
mainloop:
...
taster2down:
	sbic	ioPIND,2
	rjmp	taster3down ; Abwarten des Tastendrucks
	ldi	r17,1
	rjmp 	transmit

taster3down:
	sbic	ioPIND,3
	rjmp	taster2down ; Abwarten des Tastendrucks
	ldi r17,0
	rjmp 	transmit
